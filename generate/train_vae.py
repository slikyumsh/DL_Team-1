...
X = joblib.load(DATA_PATH)  # shape: (N, 256, 256)
X_tensor = torch.from_numpy(X).unsqueeze(1)  # → (N, 1, 256, 256)
...
# Модель
vae = UNetVAE(latent_dim=LATENT_DIM, in_ch=1).to(device)
