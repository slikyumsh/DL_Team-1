...
from model import SpectrogramClassifier, SpectrogramClassifierResNet
import logging
...
if __name__=="__main__":
    ...
    # TODO придумать как сделать покрасивше
    temp_dataset = SpectrogramDataset("train")
    temp_dataset.generate_augmented_data(subset="train", augmentations_per_sample=3)
    ...
    model = SpectrogramClassifierResNet(num_classes=NUM_CLASSES)
